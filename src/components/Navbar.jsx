...
export const Navbar = () => {
  ...
  return (
    <>
      <div className="fixed bg-card flex justify-between items-center gap-6 py-5 px-8 left-1/2 translate-x-[-50%] top-[20px] rounded-full backdrop-blur-md text-text shadow-lg z-40 font-semibold">
